...
namespace CsvHelper.Tests
{
	...
	public class CsvWriterNonGenericMappingTests
	{
		[Fact]
		public void WriteMultipleNamesTest()
		{
			IEnumerable records = new List<MultipleNamesClass>
			{
		...
		public void SameNameMultipleTimesTest()
		{
			...
			{
				IEnumerable records = new List<SameNameMultipleTimesClass>
				{
		...
		public void ConvertUsingTest()
		{
			...
			{
				IEnumerable records = new List<TestClass>
				{
